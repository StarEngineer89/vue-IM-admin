<template>
    <div class="registration-stats-page">
        <!-- Header Section -->
                        ...
                        <div class="stats-header" @click="toggleExpand(key)">
                            ...
                            <div class="stats-summary">
                                <span class="summary-text">
                                    当日{{ value.total || value.users_count || 0 }}人注册(共{{ value.count || value.total_count || 0 }}次记录)
                                </span>
                            </div>
                            ...
                            <div class="user-list">
                                ...
                                >
                                    ...
                                    <div class="user-info">
                                        ...
                                        <div class="user-register-info">{{ user.account || user.email || '' }}</div>
                                    </div>
                                </div>
...
<script setup>
    ...
    function Query(){
        ...
        axios.post('/admin/analyse/countSignups', param.value).then( res => {
            if (res.status == 200) {
