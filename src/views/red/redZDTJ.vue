<template>
    <div class="page-t">
        ...
        <el-table :data="tableData.slice(0, 100)" @selection-change="SelectionChange" border max-height="100vh - 350px">
            ...
            <el-table-column prop="" label="UID"  show-overflow-tooltip />
            <el-table-column prop="" label="会员昵称"  show-overflow-tooltip />
            <el-table-column prop="" label="交易类型"  show-overflow-tooltip />
            <el-table-column prop="" label="交易金额"  show-overflow-tooltip />
            <el-table-column prop="" label="交易方式"  show-overflow-tooltip />
            <el-table-column prop="" label="交易时间"  show-overflow-tooltip />
